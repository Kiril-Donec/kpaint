...
public:
  SpritePosition() : m_layerId(doc::NullId), m_frame(0) {}
  ...
  void layer(doc::Layer* layer) { m_layerId = (layer ? layer->id() : doc::NullId); }
  void layerId(doc::ObjectId layerId) { m_layerId = layerId; }
  void frame(doc::frame_t frame) { m_frame = frame; }
  bool operator==(const SpritePosition& o) const
  {
    return m_layerId == o.m_layerId && m_frame == o.m_frame;
  }
  bool operator!=(const SpritePosition& o) const
  {
    return m_layerId != o.m_layerId || m_frame != o.m_frame;
