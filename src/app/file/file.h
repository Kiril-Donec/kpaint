...
public:
  ...
  FormatOptionsPtr formatOptions() const { return m_formatOptions; }
  ...
  bool hasFormatOptionsOfDocument() const { return (m_document->formatOptions() != nullptr); }
  ...
  void sequenceSetHasAlpha(bool hasAlpha) { m_seq.has_alpha = hasAlpha; }
  int sequenceFlags() const { return m_seq.flags; }
