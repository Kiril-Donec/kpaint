...
public:
  ...
  SelectBoxState(SelectBoxDelegate* delegate, const gfx::Rect& rc, Flags flags);
  ~SelectBoxState();
  Flags getFlags();
...
private:
  ...
  int hitTestRulers(Editor* editor, const gfx::Point& mousePos, const bool updateMovingRulers);
