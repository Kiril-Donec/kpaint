...
// ifdef ENABLE_DEVMODE // TODO enable this on Release when KPaint supports
...
// ifndef __APPLE__ // Zoom sliding two fingers option only on macOS
 ...
 if ENABLE_SENTRY
  ...
  void loadFromPreferences()
  {
    ...
    // "Show KPaint file dialog" option is the inverse of the old
...
// ifdef LAF_WINDOWS // Show Tablet section on Windows
 ...
 ifdef ENABLE_DEVMODE
  ...
  bool showDialogToInstallExtension(const std::string& filename)
  {
    ...
    // Check if the filename corresponds to kpaint-default theme
...
private:
 ...
 ifdef ENABLE_SCRIPTING
  ...
  void onAddExtension()
  {
    base::paths exts = { "kpaint-extension", "zip" };
    base::paths filename;
